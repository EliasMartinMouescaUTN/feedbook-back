...
func sampleOwnProfile(presets []AvatarPreset) Profile {
	return Profile{
		...
		PublicLibrary: []LibraryBook{
			{Title: "The Secret History", CoverImageURL: coverURL("9781400031702")},
			{Title: "Ficciones", CoverImageURL: coverURL("9780802130303")},
			{Title: "Never Let Me Go", CoverImageURL: coverURL("9781400078776")},
			{Title: "Beloved", CoverImageURL: coverURL("9781400033416")},
			{Title: "Pale Fire", CoverImageURL: coverURL("9780679723424")},
			{Title: "The Waves", CoverImageURL: coverURL("9780156949606")},
		},
...
func samplePublicProfile(presets []AvatarPreset) Profile {
	return Profile{
		...
		PublicLibrary: []LibraryBook{
			{Title: "One Hundred Years of Solitude", CoverImageURL: coverURL("9780060883287")},
			{Title: "The Shadow of the Wind", CoverImageURL: coverURL("9780143034902")},
			{Title: "Ficciones", CoverImageURL: coverURL("9780802130303")},
			{Title: "Invisible Cities", CoverImageURL: coverURL("9780156453806")},
			{Title: "Austerlitz", CoverImageURL: coverURL("9780811216548")},
			{Title: "If on a winter's night a traveler", CoverImageURL: coverURL("9780156439619")},
			{Title: "The Left Hand of Darkness", CoverImageURL: coverURL("9780441478125")},
			{Title: "Pedro Paramo", CoverImageURL: coverURL("9780802133908")},
			{Title: "The Master and Margarita", CoverImageURL: coverURL("9780143108276")},
		},
		FeaturedReviews: []FeaturedReview{
...
func sampleReviews() map[string][]Review {
	return map[string][]Review{
		"1": {
			{ID: "r1", ReviewerName: "Evelyn Vance", ReviewerAvatar: avatarURL("witch"), Rating: 5, Text: "A novel built on obsession, elitism and silence. Tartt makes every scene feel both intimate and dangerous.", Likes: 42, CreatedAt: "2d ago"},
			{ID: "r2", ReviewerName: "Julian Thorne", ReviewerAvatar: avatarURL("pirate"), Rating: 4, Text: "Dense and rewarding. Every page pulls you deeper into its dark academia world.", Likes: 18, CreatedAt: "1w ago"},
		},
		"2": {
			{ID: "r3", ReviewerName: "Julian Thorne", ReviewerAvatar: avatarURL("pirate"), Rating: 5, Text: "A profound meditation on destiny. The novel keeps its labyrinth open long after the final page.", Likes: 31, CreatedAt: "4h ago"},
		},
		"3": {
			{ID: "r4", ReviewerName: "Evelyn Vance", ReviewerAvatar: avatarURL("witch"), Rating: 5, Text: "Morrison writes memory like weather. Every return to this novel feels heavier and more precise.", Likes: 67, CreatedAt: "1w ago"},
		},
	}
}
